...
<div id="page">
    ...
    <header id="header" class="header">
        <div class="container">
            ...
            <?php if ($logo): ?>
                <div id="logo">
                    <a href="<?php print $front_page; ?>" title="<?php print t('Back to Home'); ?>" rel="home" >
    ...
    <?php if($content_bottom = render($page['content_bottom'])): ?>
        <footer id="content_bottom" class="content-bottom">
            <div class="container">
    ...
    <div class="back-to-top"><a title="<?php print t('Back to Top')?>" class="btn-btt" href="#Top"><?php print t('Back to Top')?></a></div>
